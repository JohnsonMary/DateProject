...
public class TV {
	...
	public void setVolumeLevel(int volumeLevel) {
		...
		if(on==true && volumeLevel>=1 && volumeLevel<=7 ) {
			...
			System.out.println("ERROR:The tv is alreday OFF or invalid volume level");
		}
	...
	if(on==false) {
		...
		System.out.println("ERROR:The TV is already ON");
	}
	...
	public void turnOff() {
		...
		if(on==false) {
			System.out.println("The TV is alredy OFF");
	}else if(on=true){
